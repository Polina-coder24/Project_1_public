"""Модуль создания рамки под тематику Хэллоуин"""
from PIL import Image
import requests
from io import BytesIO


def halloween(qrcode_path, image_url, output_path):
  """Декорирует QR-код под тематику "Хэллоуин", вставляет изображение вокруг указанного QR-кода и сохраняет результат."""
